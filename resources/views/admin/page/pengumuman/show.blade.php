                    ...
                    <div class="card">
                        <div class="card-body task-detail">
                            ...
                            <div class="d-flex mb-3">
                                <img class="flex-shrink-0 me-3 rounded-circle avatar-md" alt="64x64" src="{{ asset($pengumuman->gambar) }}">
                                <div class="flex-grow-1">
                                    <h4 class="media-heading mt-0">{{ $pengumuman->user->name }}</h4>
                            ...
                            <div>
                                ...
                                <div class="d-flex mb-3">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <a href="{{ route('deleteComment', ['id' => $komen->id]) }}" class="text-danger font-13">Hapus</a>
                                    </div>
                                </div>
                                @endforeach
