                    ...
                    <div class="row">
                                        ...
                                        <li>
                                            ...
                                            <div class="post--item">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="post--img">
                                                            <a href="{{ route('kegiatanetails', ['slug' => $berita->slug]) }}" class="thumb">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="post--action">
                                                            <a href="{{ route('kegiatanetails', ['slug' => $berita->slug]) }}" class="thumb">Continue Reading...</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="pagination--wrapper ptop--30 pbottom--30 clearfix">
                                <p class="pagination-hint float--left">Page {{ $kegiatan->currentPage() }} of {{ $kegiatan->lastPage() }}</p>
                        
                                <ul class="pagination float--right">
                                    @if ($kegiatan->onFirstPage())
                                        <li class="disabled"><span><i class="fa fa-long-arrow-left"></i></span></li>
                                    @else
                                        <li><a href="{{ $kegiatan->previousPageUrl() }}"><i class="fa fa-long-arrow-left"></i></a></li>
                                    @endif
                        
                                    @for ($i = 1; $i <= $kegiatan->lastPage(); $i++)
                                        <li class="{{ $i == $kegiatan->currentPage() ? 'active' : '' }}">
                                    ...
                                    @if ($kegiatan->hasMorePages())
                                        <li><a href="{{ $kegiatan->nextPageUrl() }}"><i class="fa fa-long-arrow-right"></i></a></li>
                                    @else
