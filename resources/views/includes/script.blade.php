...
<script src="{{ asset('') }}portal/js/resizesensor.min.js"></script>

<!-- ==== Sticky Sidebar Plugin ==== -->
<script src="{{ asset('') }}portal/js/theia-sticky-sidebar.min.js"></script>

<!-- ==== Zoom Plugin ==== -->
<script src="{{ asset('') }}portal/js/jquery.zoom.min.js"></script>

<!-- ==== Bar Rating Plugin ==== -->
<script src="{{ asset('') }}portal/js/jquery.barrating.min.js"></script>
